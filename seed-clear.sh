...
# Update the MongoDB URI in the seed script
cd backend

# Create a temporary seed file with the correct MongoDB URI
...
// Override the MongoDB URI for this script
process.env.MONGODB_URI = 'mongodb://localhost:27018/ecommerce-pwa';
